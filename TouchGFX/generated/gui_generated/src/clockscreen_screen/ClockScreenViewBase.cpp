...
void ClockScreenViewBase::updateItemCallbackHandler(touchgfx::DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
    ...
    if (items == &scrollMonthSelectedListItems)
    {
        touchgfx::Drawable* d = items->getDrawable(containerIndex);
    ...
    if (items == &scrollDaySelectedListItems)
    {
        touchgfx::Drawable* d = items->getDrawable(containerIndex);
        TextContainerHigh* cc = (TextContainerHigh*)d;
    ...
    if (items == &scrollYearSelectedListItems)
    {
        touchgfx::Drawable* d = items->getDrawable(containerIndex);
        TextContainerHigh* cc = (TextContainerHigh*)d;
    ...
    if (items == &scrollHourSelectedListItems)
    {
        touchgfx::Drawable* d = items->getDrawable(containerIndex);
        TextContainerHigh* cc = (TextContainerHigh*)d;
    ...
    if (items == &scrollMinSelectedListItems)
    {
        touchgfx::Drawable* d = items->getDrawable(containerIndex);
        TextContainerHigh* cc = (TextContainerHigh*)d;
    ...
    if (items == &scrollSecSelectedListItems)
    {
        touchgfx::Drawable* d = items->getDrawable(containerIndex);
        TextContainerHigh* cc = (TextContainerHigh*)d;
